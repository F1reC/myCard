...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 left-0 right-0 z-[100] flex max-h-screen flex-col-reverse gap-2 p-4 sm:right-auto sm:bottom-4 sm:left-1/2 sm:-translate-x-1/2 md:max-w-[420px]",
      className
    )}
    {...props}
  />
